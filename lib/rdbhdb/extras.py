"""
Custom cursors for rdbhdb 
Adapted from psycopg2, a python DB2 API for PostgreSQL

"""
# rdbhdb/extras.py - custom cursor classes for rdbhdb
#
...
try:
    from rdbhdb.extras_asyncio import *
except:
    pass
